...
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/autoanalyzeCommands.py,v 1.233.2.7 2009/08/20 23:55:16 rhuey Exp $
#
# $Id: autoanalyzeCommands.py,v 1.233.2.7 2009/08/20 23:55:16 rhuey Exp $
#
#
#
#
...
"""
import types, Tkinter, commands, os, copy, glob, popen2
...
from MolKit.molecule import  MoleculeSet, Molecule, AtomSet, Atom, Bond
...
class ADReadMacro(MVCommand):
    ...
    \nSynopsis:\n 
        None<-ADanalzye_readMacromolecule(macroFile=None)
    \nArguments:\n   
...
class ADShowBindingSite(MVCommand):
    ...
    def onRemoveObjectFromViewer(self, obj):
        if self.vf.docked and obj==self.vf.docked.ligMol:
            self.reset()
            for v in [self.updateDisplay, self.showCloseContactSpheres, self.showSS, \
                    self.showMsms, self.showResLabels]:
                v.set(1)
