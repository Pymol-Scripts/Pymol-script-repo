...
# 
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/Utilities24/summarize_docking.py,v 1.1.2.1 2009/02/25 18:13:04 rhuey Exp $ 
#
# $Id: summarize_docking.py,v 1.1.2.1 2009/02/25 18:13:04 rhuey Exp $
#
import os, glob
