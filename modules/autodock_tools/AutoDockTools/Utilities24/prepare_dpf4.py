...
# 
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/Utilities24/prepare_dpf4.py,v 1.14 2010/01/12 16:53:22 rhuey Exp $
#
import os,sys
...
if __name__ == '__main__':
    ...
    try:
        opt_list, args = getopt.getopt(sys.argv[2:], 'sLShvl:r:i:o:x:p:k:')
