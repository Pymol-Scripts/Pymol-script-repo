...
# 
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/Utilities24/prepare_dpf41.py,v 1.1.2.2 2009/04/06 18:49:44 rhuey Exp $
#
...
class DockingParameter41FileMaker:
    """Accept a <ligand>.pdbqt and <receptor>.pdbqt and create
    <ligand>_<receptor>41.dpf
    """
    ...
    def write_dpf(self, dpf_filename,
              parm_list = genetic_algorithm_local_search_list4_1, 
              pop_seed = False):
        if not dpf_filename:
...
if __name__ == '__main__':
    ...
    dm = DockingParameter41FileMaker(verbose=verbose)
...
#prepare_dpf41.py -l indinavir.pdbq -r 1hsg.pdbqs -p ga_num_evals=20000000 -p ga_pop_size=150 -p ga_run=17 -i ref.dpf -o testing.dpf 
