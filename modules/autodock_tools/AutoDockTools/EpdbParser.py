...
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/EpdbParser.py,v 1.6 2005/08/30 17:00:50 rhuey Exp $
#
# $Id: EpdbParser.py,v 1.6 2005/08/30 17:00:50 rhuey Exp $
#
#
#
#
    ...
    def _parse(self, allLines):
        ...
        for i in range(lineLen):
            ...
            if find(l, 'INPUT-PDBQ: ATOM')==0:
                ...
                break
        #at this point i is index, atmCtr is number of atoms
        #while find(l, '___')<0:
        #    l = allLines[i]
        #    i = i + 1
        i = i + 6
        #for x in range(atmCtr):
        for x in range(i,lineLen):
            #process energy lines
            i = i+1
            l = allLines[i]
            if find(l, 'Total')==0:
                self.energyLines = self.energyLines[:-2]
                break
