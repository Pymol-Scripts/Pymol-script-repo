...
Input:  filename (string)"""
    ...
    def __init__(self, name='Write Molecule', **kw):
        ...
        ip.append(datatype='string',  name='filename')
        ip.append(datatype='int', required=False, name='sort')
        ip.append(datatype='list', required=False, name='records')

        op = self.outputPortsDescr
        op.append(datatype='string', name='filename')

        code = """def doit(self, mols, filename, sort=False, records=['ATOM','HETATM']):
...
"""
    ...
    def __init__(self, name='Select Nodes', **kw):
        ...
        code = """def doit(self, molecules,  nodeType, \
...
#        self.cpk = Spheres('CPK', inheritMaterial=0)
        ...
        code = """def doit(self, atoms, radii=None, colors=None, quality=None,
name=None, geoms=None, instanceMatrices=None, geomOptions=None, parent=None):
...
class AtomsAsSticks(NetworkNode):
    ...
    def __init__(self, name='Sticks', **kw):
        ...
        code = """def doit(self, atoms, colors=None, instanceMatrices=None, \
                           cradii=None):
    if atoms is None:
        return
    if colors is None:
...
"""
    def __init__(self, name='gSESVertices', **kw):
        ...
        ip.append(datatype='int', required=False, name='selnum')
        ip.append(datatype='int', required=False, name='component')
        ip.append(datatype='string', required=False, name='ftype')
        ip.append(datatype='string', required=False, name='vtype')
        ...
        code = """def doit(self, msms, nodes=None, selnum=3, component=0, \
        ftype='contact', vtype='inside'):
...
try:
    ...
    """
        def __init__(self, name='SurfaceAtoms', **kw):
            ...
            code = """def doit(self, msms, nodes=None, component=0, cutoff=0.0):
        vf,vi,f = msms.getTriangles()
...
class AtomsAsMSMS(NetworkNode):
    ...
    def __init__(self, name='MSMS', **kw):
        ...
        ip.append(datatype='float', required=False, name='probe_radius')
        ip.append(datatype='int', required=False, name='allComp')
        
        op = self.outputPortsDescr
        op.append(datatype='MSMSobject', name='MSMS')
        
        code = """def doit(self, atoms, radii=None, seedAtoms=None, \
        density=1.0, probe_radius=1.5, allComp=0):
    if atoms is None:
        return
    if allComp is None:
        allComp = 0
...
OutputPort:
    ...
    def __init__(self, name='get MSMS areas', **kw):
        ...
        code = """def doit(self, msms, component=0):
...
"""
    ...
    def __init__(self, name='get burried MSMS triangles', **kw):
        ...
        ip.append(datatype='int', required=False, name='selnum')
        ip.append(datatype='int', required=False, name='component')
        ip.append(datatype='int', required=False, name='negate')
        ip.append(datatype='string', required=False, name='areaMode')
        ...
        code = """def doit(self, msms, nodes, nodes2=None, selnum=3, \
        component=0, negate=False, areaMode='SemiAna'):
...
#        op.append(datatype='normals3D', name='vnormals')
        ...
        code = """def doit(self, atoms, radii=None, colors=None, density=1.0, \
        probe_radius=1.5):
...
molkitlib.addNode(LinesMacro, 'Lines Macro', 'Macros')
molkitlib.addNode(CPKMacro, 'CPK Macro', 'Macros')
...
if msmsFound==1:
    molkitlib.addNode(MSMSMacro, 'MSMS Macro', 'Macros')
