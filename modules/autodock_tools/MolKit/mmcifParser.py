# $Header: /opt/cvs/python/packages/share1.5/MolKit/mmcifParser.py,v 1.20 2008/10/29 17:04:35 sargis Exp $
#
# $Id: mmcifParser.py,v 1.20 2008/10/29 17:04:35 sargis Exp $
                ...
                for Line_ in allLines[i_line:]: #this loop collects data names and data values
                    ...
                    if Line_[0] == '_':  #First get data name tag which start with '_'
                        ...
                        while allLines[i_line][0] != '_' and allLines[i_line][:5]!= 'loop_':
                                ...
                                new_list = [] 
                                flag_quote = 1
                                for item in tmp_list: #this loop can be removed
                                # if there is no quoted text in the tmp_string
                                    if flag_quote:
                                        ...
                                        if item.find('\'') == -1: pass
                                            ...
                                            if item != "": new_list.append( tmp_str )
                                            flag_quote = 1
                                tmp_list = new_list  #remove last
