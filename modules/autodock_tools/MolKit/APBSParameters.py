...
#
# $Header: /opt/cvs/python/packages/share1.5/MolKit/APBSParameters.py,v 1.21 2008/03/31 17:58:20 annao Exp $
#
# $Id: APBSParameters.py,v 1.21 2008/03/31 17:58:20 annao Exp $
#
import os, types
...
class APBSParams:
    ...
    def __init__(self, name='Default', **kw):
        ...
        from mglutil.util.packageFilePath import getBinary, findFilePath
        if not hasattr(self,'APBS_Path'):
            try:
                ...
                #traceback.print_exc()
                #tkMessageBox.showerror("ERROR: ", "Could not find APBS executable")
                self.APBS_Path = 'apbs'
