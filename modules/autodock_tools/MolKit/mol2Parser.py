...
#
# $Header: /opt/cvs/python/packages/share1.5/MolKit/mol2Parser.py,v 1.11 2008/08/22 16:55:37 sargis Exp $
#
# $Id: mol2Parser.py,v 1.11 2008/08/22 16:55:37 sargis Exp $
#
...
class Mol2Parser(MoleculeParser):
    ...
    Mol2Tags = ["@<TRIPOS>AlT_TYPE","@<TRIPOS>ANCHOR_ATOM",
                ...
                "@<TRIPOS>RINF_CLOSURE", "@<TRIPOS>ROTABLE_BOND",
