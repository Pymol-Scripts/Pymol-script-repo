...
# 
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/Utilities24/write_all_complexes.py,v 1.2.4.1 2009/09/17 19:45:53 rhuey Exp $
#
# $Id: write_all_complexes.py,v 1.2.4.1 2009/09/17 19:45:53 rhuey Exp $
#
import os
