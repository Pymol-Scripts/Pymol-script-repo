# $Header: /opt/cvs/python/packages/share1.5/mglutil/splashregister/about.py,v 1.9 2008/07/14 21:58:26 vareille Exp $
# $Id: about.py,v 1.9 2008/07/14 21:58:26 vareille Exp $
import Tkinter, os
