...
# $Header: /opt/cvs/python/packages/share1.5/mglutil/gui/InputForm/Tk/gui.py,v 1.42 2008/07/14 21:58:26 vareille Exp $
#
# $Id: gui.py,v 1.42 2008/07/14 21:58:26 vareille Exp $
#      
...
optional arguments :
    ...
    def __init__(self, master, root, descr, modal=1, blocking=0,
                 ...
                 scrolledFrame=0, width=None, height=None,
                 help=None):
...
##                 self.autoRaiseID = None
    ...
    def buildOkCancelButtons(self, okCfg, cancelCfg, help=None):
        ...
        f1.pack(side='bottom', fill ='x', expand=1)
        # Ok button
