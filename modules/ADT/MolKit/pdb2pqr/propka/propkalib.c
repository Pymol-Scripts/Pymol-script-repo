...
/*-----------------------------------------------
              @(target):= _propkalib.so
  ------------------------------------------------*/
#define SWIG_init    init_propkalib

#define SWIG_name    "_propkalib"
void runPKA(int,char *,char *);
...
static PyObject *_wrap_runPKA(PyObject *self, PyObject *args) {
    ...
    if(!PyArg_ParseTuple(args,(char *)"OOO:runPKA",&obj0,&obj1,&obj2)) goto fail;
    {
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"runPKA", _wrap_runPKA, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
