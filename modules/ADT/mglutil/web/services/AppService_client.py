...
#     /home/clem/projects/opal/sf/opal/opal-py/temp/zsi/build/scripts-2.6/wsdl2py opal.wsdl
# 
##################################################
...
class AppServicePortTypeSoapBindingSOAP:
    ...
    # op: getJobStatistics
    def getJobStatistics(self, request, **kw):
        if isinstance(request, getJobStatisticsRequest) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="http://nbcr.sdsc.edu/opal/getJobStatistics", **kw)
        # no output wsaction
        response = self.binding.Receive(getJobStatisticsResponse.typecode)
        return response
