...
#
#
# $Header: /opt/cvs/python/packages/share1.5/AutoDockTools/MoleculePreparation.py,v 1.70 2010/06/04 17:28:35 rhuey Exp $ 
#
#
#
import os, string
...
"""
    ...
    def write(self, outputfilename=None):
        ...
        if self.dict is not None:
            ...
            ostr = ostr + "],\n\t\t\t'total_charge' : " 
            # net charge
            total_charge = Numeric.add.reduce(self.molecule.allAtoms.charge)
